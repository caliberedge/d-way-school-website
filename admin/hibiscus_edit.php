...
$hibiscus = $_POST['info'];
  ...
  $query = "UPDATE home SET hibiscus='$hibiscus' where id = '$ID'";
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>School Fees</li>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10" >
                        <textarea class="form-control " name="info" required><?= $row['hibiscus']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
