...
$conditions = $_POST['sermon'];



  $query = "UPDATE home SET sermon='$conditions' where id = '$ID'";
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Sermon</li>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-8" >
                        <textarea class="form-control " name="sermon" required><?= $row['sermon']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
